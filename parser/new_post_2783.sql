INSERT OR IGNORE INTO posts (id, bbsid, board_id, user_id, title, content, content_text, signature, posted_at, reply_count, source_file, wayback_ts) VALUES (2784, 212416, 8, 44, '[读碟手记]卢旺达饭店和人权、人性的思考', '<br/>
...
<div style="border: 1px dashed green;padding: 4px; margin-bottom: 2em;font:78% Verdana;">
	...
	<img border="0" src="http://www.cafewoo.net/images/post.gif"/>
	&nbsp;回复者: winyhom&nbsp;&nbsp;回复时间: 2005-12-22 04:14:16</span><span style="display:block;font-weight:bold;text-align:right">(2)</span>
	<span style="display:block;"><p>When a nation fell in the madness, the world also closes eyes, a hotel manager who named Paul Rusesabagina warmly welcomed them. The hotel was opened by foreigners, so was safer than the general people. There were only 80 United Nations soldiers in Rwanda, but 4 of them were assigned in that hotel, although forbidden to shoot.</p>

<p>Paul was a kind person, except for his family and neighbor, he still took in many civilians of Tutsi in the hotel. They said that here is an oasis in the desert because the Hutus dared not to beat in. he thought the technology of 1994 had already been developed, we had satellite TV and cell phone, as long as the whole world knew that what took place here, United Nations would certainly interfere with the incident immediately, and then the massacre would stop.</p>

<p>But they were wrong. In foreign politicians'' eyes, the death value of the person of Rwanda is less than a pot ticket. Foreign countries started to pick up their people, withdrawing all the foreigners immediately. The bus came, the excited Father and the children rushed to the bus. But the soldiers said, "Sorry Father, only the foreigner can get in the bus."</p>

<p>The rain was heavy, the British reporter said "take away the umbrella from me, I feel shameful". In front of the completely naked massacre, international social was so flabbiness and false. What did those politicians who always mentioning of the world peace do? What did United Nations Security Council do? What did the soldiers do? This is not the humiliation of one person, it''s the humiliation of the whole world.</p>

<p>In the movie, a Tutsi person asked Paul, "Why does people are thus ruthlessness?" Paul said, "Hatred? Insanity? I don''t know..."</p>

<p>After the withdrawing of foreigners, the hotel is not the Noah''s ark any more. Paul used the money, social intercourse and intelligences, the hard effect. However, his love and courage saved 1268 people.</p>

<p>Under the uncommon environment, the ordinary human nature usually will burst out a shining glory of glitter, this is a well know fact already. But this time, why did I such shock and moved? From more than 10 years from then on, wars kill brutally and bleed nearly happen everyday. Peace and happiness, why can''t become the dream of everyone?</p></span>
</div>
...
<div style="border: 1px dashed green;padding: 4px; margin-bottom: 2em;font:78% Verdana;">
	...
	<img border="0" src="http://www.cafewoo.net/images/post.gif"/>
	&nbsp;回复者: winyhom&nbsp;&nbsp;回复时间: 2005-12-22 04:15:22</span><span style="display:block;font-weight:bold;text-align:right">(3)</span>
	<span style="display:block;"><p>推荐你看<sometims in april>哦</p></span>
</div>
...
<input id="comment_pos... [内容过长，已截断]', '在看这部电影之前，我对于这段历史知之甚少。我只记得在新闻里曾经读过这段资料：1994年4月到7月的100天里，卢旺达发生种族大屠杀，死亡近百万。可以说，没有这部影片，那么我对这场发生在离我们如此遥远的非洲大陆上的惨剧的概念，永远只会停留在那一段简短的新闻资料。我永远无法明白死亡100万人对于一个国家，对于一个民族或者对于幸存下来的人来说，意味着什么。
　　
...
帐号：密码：', NULL, '2005-07-15 05:56:17', 1, 'rails_212416', '20070706044156');
